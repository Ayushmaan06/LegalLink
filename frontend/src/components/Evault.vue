  ...
  <div class="evault">
    ...
    <div class="container">
      ...
      <div class="upload-section">
        <!-- Use FancyUpload and listen for the file-selected event -->
        <FancyUpload @file-selected="updateSelectedFile" />
...
export default {
  ...
  methods: {
    updateSelectedFile(file) {
      // Update the selected file from the FancyUpload component
    ...
    async handleUpload() {
      ...
      try {
        ...
        // Call the blockchain logic to handle IPFS upload and on-chain recording.
